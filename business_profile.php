...
return array (
  ...
  'Already ' => '',
  'Already with us' => 'CiviCiti Profiles',
  'An Activist' => '',
  'An error occurred. The file shouldn`t be bigger than 5Mb.<br/> File`s format: jpg | jpeg | png | tiff | gif.' => '',
  'An initiative' => '',
  'An institution' => '',
  'Answer' => '',
  'Any organization or public figure can create such profile.' => 'Organizations of any size, or a public figure, can create a profile',
  'Articles' => '',
  'Authorities' => '',
  'Authors' => '',
  ...
  'The profile has no subscribers yet, become the first' => 'Suscribe to this profile now',
  'The role of the ' => '',
  ...
  'Urban mass media, charity funds, NGOs and public organizations,{br /} small companies and brands' => 'All types of organizations, from small citizen groups and small businesses, to local and national media groups,{br /} to public bodies and large companies',
  'Url ' => '',
  ...
  'success Identifier ' => '',
  'tags' => '',
  'there are no events in the feed yet' => 'No events to display yet',
  'title' => '',
  'unsubscribe' => '',
  'verify email' => '',
  'website' => '',
  'website ' => '',
  'with the audience' => 'belong to an organization?',
  'with us' => '',
